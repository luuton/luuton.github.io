...
button.bg-\\[var\\(--primary\\)\\] {
    ...
    border: none;
}</style>`,1);function Fr(c,s){Ha(s,!1);let w=xt.mode??"local",E=xt.meting_api??"https://www.bilibili.uno/api?server=:server&type=:type&id=:id&auth=:auth&r=:r",L=xt.id??"14164869977",C=xt.server??"netease",I=xt.type??"playlist",x=F(!0),A=F(!1),d=F(!1),g=F(!1),P=F(0),k=F(0),j=F(.3),T=F(!1),u=F(!1),M=F(!1),h=F(2),et=F("error"),at=F(!1),$=F({title:"示例歌曲",artist:"示例艺术家",cover:"/favicon/favicon-light-192.png",url:"",duration:0}),p=F([]),y=F(0),a=F(),Q=F(),U=F();const $e=[{id:1,title:"三日月の舞 (関西大会突破 Ver.）",artist:"北宇治高校吹奏楽部",cover:"assets/music/cover/sryzw.jpg",url:"assets/music/url/sryzw.mp3",duration:240},{id:2,title:"衡山路宛平路",artist:"ChiliChill",cover:"assets/music/cover/衡山路宛平路.jpg",url:"assets/music/url/衡山路宛平路.mp3",duration:240},{id:3,title:"コロニーの彼女（I_006A）",artist:"照井順政",cover:"assets/music/cover/コロニーの彼女（I_006A）.jpg",url:"assets/music/url/コロニーの彼女（I_006A）.mp3",duration:240},{id:4,title:"眩耀夜行",artist:"スリーズブーケ",cover:"assets/music/cover/xryx.jpg",url:"assets/music/url/xryx.mp3",duration:180},{id:5,title:"春雷の頃",artist:"22/7",cover:"assets/music/cover/cl.jpg",url:"assets/music/url/cl.mp3",duration:200},{id:6,title:"ひとり上手",artist:"Kaya",cover:"assets/music/cover/hitori.jpg",url:"assets/music/url/hitori.mp3",duration:240}];async function Re(){if(!E||!L)return;l(u,!0);const n=E.replace(":server",C).replace(":type",I).replace(":id",L).replace(":auth","").replace(":r",Date.now().toString());try{const S=await fetch(n);if(!S.ok)throw new Error("meting api error");const H=await S.json();l(p,H.map(W=>{let ft=W.name??W.title??"未知歌曲",Ft=W.artist??W.author??"未知艺术家",R=W.duration??0;return R>1e4&&(R=Math.floor(R/1e3)),(!Number.isFinite(R)||R<=0)&&(R=0),{id:W.id,title:ft,artist:Ft,cover:W.pic??"",url:W.url??"",duration:R}})),t(p).length>0&&$t(t(p)[0]),l(u,!1)}catch{kt("Meting 歌单获取失败"),l(u,!1)}}function We(){!t(a)||!t($).url||(t(x)?t(a).pause():t(a).play())}function yt(){l(A,!t(A)),t(A)&&(l(g,!1),l(d,!1))}function _t(){l(d,!t(d)),t(d)&&(l(A,!1),l(g,!1))}function re(){l(g,!t(g))}function Ne(){l(M,!t(M))}function qe(){l(h,(t(h)+1)%3)}function Ye(){if(t(p).length<=1)return;const n=t(y)>0?t(y)-1:t(p).length-1;wt(n)}function It(){if(t(p).length<=1)return;let n;if(t(M))do n=Math.floor(Math.random()*t(p).length);while(n===t(y)&&t(p).length>1);else n=t(y)<t(p).length-1?t(y)+1:0;wt(n)}function wt(n){if(n<0||n>=t(p).length)return;const S=t(x);l(y,n),t(a)&&t(a).pause(),$t(t(p)[t(y)]),(S||!t(x))&&setTimeout(()=>{t(a)&&(t(a).readyState>=2?t(a).play().catch(()=>{}):t(a).addEventListener("canplay",()=>{t(a).play().catch(()=>{})},{once:!0}))},100)}function Et(n){return n.startsWith("http://")||n.startsWith("https://")||n.startsWith("/")?n:`/${n}`}function $t(n){!n||!t(a)||(l($,{...n}),n.url?(l(u,!0),t(a).pause(),K(a,t(a).currentTime=0),l(P,0),l(k,n.duration??0),t(a).removeEventListener("loadeddata",ie),t(a).removeEventListener("error",se),t(a).removeEventListener("loadstart",ne),t(a).addEventListener("loadeddata",ie,{once:!0}),t(a).addEventListener("error",se,{once:!0}),t(a).addEventListener("loadstart",ne,{once:!0}),K(a,t(a).src=Et(n.url)),t(a).load()):l(u,!1))}function ie(){l(u,!1),t(a)?.duration&&t(a).duration>1&&(l(k,Math.floor(t(a).duration)),t(p)[t(y)]&&K(p,t(p)[t(y)].duration=t(k)),K($,t($).duration=t(k)))}function se(n){l(u,!1),kt(`无法播放 "${t($).title}"，正在尝试下一首...`),t(p).length>1?setTimeout(()=>It(),1e3):kt("播放列表中没有可用的歌曲")}function ne(){}function kt(n){l(et,n),l(at,!0),setTimeout(()=>{l(at,!1)},3e3)}function Oe(){l(at,!1)}function Ke(n){if(!t(a)||!t(Q))return;const S=t(Q).getBoundingClientRect(),W=(n.clientX-S.left)/S.width*t(k);K(a,t(a).currentTime=W),l(P,W)}function Ue(n){if(!t(a)||!t(U))return;const S=t(U).getBoundingClientRect(),H=Math.max(0,Math.min(1,(n.clientX-S.left)/S.width));l(j,H),K(a,t(a).volume=t(j)),l(T,t(j)===0)}function oe(){t(a)&&(l(T,!t(T)),K(a,t(a).muted=t(T)))}function le(n){if(!Number.isFinite(n)||n<0)return"0:00";const S=Math.floor(n/60),H=Math.floor(n%60);return`${S}:${H.toString().padStart(2,"0")}`}function He(){t(a)&&(t(a).addEventListener("play",()=>{l(x,!0)}),t(a).addEventListener("pause",()=>{l(x,!1)}),t(a).addEventListener("timeupdate",()=>{l(P,t(a).currentTime)}),t(a).addEventListener("ended",()=>{t(h)===1?(K(a,t(a).currentTime=0),t(a).play().catch(()=>{})):t(h)===2||t(y)<t(p).length-1||t(M)?It():l(x,!1)}),t(a).addEventListener("error",n=>{l(u,!1)}),t(a).addEventListener("stalled",()=>{}),t(a).addEventListener("waiting",()=>{}))}Sa(()=>{l(a,new Audio),K(a,t(a).volume=t(j)),He(),w==="meting"?Re():(l(p,[...$e]),t(p).length>0?$t(t(p)[0]):kt("本地播放列表为空"))}),Pa(()=>{t(a)&&(t(a).pause(),K(a,t(a).src=""))}),za();var ue=it(),Ve=tt(ue);{var Xe=n=>{var S=vr(),H=tt(S);{var W=e=>{var m=or(),_=i(m),B=i(_);f(B,{icon:"material-symbols:error",class:"text-xl flex-shrink-0"});var D=v(B,2),o=i(D,!0);r(D);var V=v(D,2),ct=i(V);f(ct,{icon:"material-symbols:close",class:"text-lg"}),r(V),r(_),r(m),Pt(()=>G(o,t(et))),b("click",V,Oe),N(e,m)};z(H,e=>{t(at)&&e(W)})}var ft=v(H,2);let Ft;var R=i(ft);let ce;var Ge=i(R);{var Je=e=>{f(e,{icon:"eos-icons:loading",class:"text-white text-lg"})},Qe=e=>{var m=it(),_=tt(m);{var B=o=>{var V=lr();N(o,V)},D=o=>{f(o,{icon:"material-symbols:music-note",class:"text-white text-lg"})};z(_,o=>{t(x)?o(B):o(D,!1)},!0)}N(e,m)};z(Ge,e=>{t(u)?e(Je):e(Qe,!1)})}r(R);var nt=v(R,2);let de;var ve=i(nt),Rt=i(ve),Wt=i(Rt);let fe;var pe=v(Wt,2),Ze=i(pe);{var ta=e=>{f(e,{icon:"eos-icons:loading",class:"text-white text-xl"})},ea=e=>{var m=it(),_=tt(m);{var B=o=>{f(o,{icon:"material-symbols:pause",class:"text-white text-xl"})},D=o=>{f(o,{icon:"material-symbols:play-arrow",class:"text-white text-xl"})};z(_,o=>{t(x)?o(B):o(D,!1)},!0)}N(e,m)};z(Ze,e=>{t(u)?e(ta):e(ea,!1)})}r(pe),r(Rt);var Nt=v(Rt,2),qt=i(Nt),aa=i(qt,!0);r(qt);var me=v(qt,2),ra=i(me,!0);r(me),r(Nt);var ge=v(Nt,2),Ct=i(ge),ia=i(Ct);f(ia,{icon:"material-symbols:visibility-off",class:"text-lg"}),r(Ct);var Yt=v(Ct,2),sa=i(Yt);f(sa,{icon:"material-symbols:expand-less",class:"text-lg"}),r(Yt),r(ge),r(ve),r(nt);var Bt=v(nt,2);let he;var Ot=i(Bt),Kt=i(Ot),be=i(Kt);let xe;r(Kt);var Ut=v(Kt,2),Ht=i(Ut),na=i(Ht,!0);r(Ht);var Vt=v(Ht,2),oa=i(Vt,!0);r(Vt);var ye=v(Vt,2),la=i(ye);r(ye),r(Ut);var _e=v(Ut,2),At=i(_e),ua=i(At);f(ua,{icon:"material-symbols:visibility-off",class:"text-lg"}),r(At);var Xt=v(At,2),ca=i(Xt);f(ca,{icon:"material-symbols:expand-more",class:"text-lg"}),r(Xt),r(_e),r(Ot);var Gt=v(Ot,2),ot=i(Gt),da=i(ot);r(ot),Me(ot,e=>l(Q,e),()=>t(Q)),r(Gt);var Jt=v(Gt,2),lt=i(Jt);let we;var va=i(lt);f(va,{icon:"material-symbols:shuffle",class:"text-lg"}),r(lt);var pt=v(lt,2),fa=i(pt);f(fa,{icon:"material-symbols:skip-previous",class:"text-xl"}),r(pt);var ut=v(pt,2);let Ee;var pa=i(ut);{var ma=e=>{f(e,{icon:"eos-icons:loading",class:"text-xl"})},ga=e=>{var m=it(),_=tt(m);{var B=o=>{f(o,{icon:"material-symbols:pause",class:"text-xl"})},D=o=>{f(o,{icon:"material-symbols:play-arrow",class:"text-xl"})};z(_,o=>{t(x)?o(B):o(D,!1)},!0)}N(e,m)};z(pa,e=>{t(u)?e(ma):e(ga,!1)})}r(ut);var mt=v(ut,2),ha=i(mt);f(ha,{icon:"material-symbols:skip-next",class:"text-xl"}),r(mt);var Dt=v(mt,2);let ke;var ba=i(Dt);{var xa=e=>{f(e,{icon:"material-symbols:repeat-one",class:"text-lg"})},ya=e=>{var m=it(),_=tt(m);{var B=o=>{f(o,{icon:"material-symbols:repeat",class:"text-lg"})},D=o=>{f(o,{icon:"material-symbols:repeat",class:"text-lg opacity-50"})};z(_,o=>{t(h)===2?o(B):o(D,!1)},!0)}N(e,m)};z(ba,e=>{t(h)===1?e(xa):e(ya,!1)})}r(Dt),r(Jt);var Fe=v(Jt,2),Lt=i(Fe),_a=i(Lt);{var wa=e=>{f(e,{icon:"material-symbols:volume-off",class:"text-lg"})},Ea=e=>{var m=it(),_=tt(m);{var B=o=>{f(o,{icon:"material-symbols:volume-down",class:"text-lg"})},D=o=>{f(o,{icon:"material-symbols:volume-up",class:"text-lg"})};z(_,o=>{t(j)<.5?o(B):o(D,!1)},!0)}N(e,m)};z(_a,e=>{t(T)||t(j)===0?e(wa):e(Ea,!1)})}r(Lt);var rt=v(Lt,2),ka=i(rt);r(rt),Me(rt,e=>l(U,e),()=>t(U));var jt=v(rt,2);let Ce;var Fa=i(jt);f(Fa,{icon:"material-symbols:queue-music",class:"text-lg"}),r(jt),r(Fe),r(Bt);var Ca=v(Bt,2);{var Ba=e=>{var m=dr(),_=i(m),B=i(_),D=i(B,!0);r(B);var o=v(B,2),V=i(o);f(V,{icon:"material-symbols:close",class:"text-lg"}),r(o),r(_);var ct=v(_,2);Ga(ct,5,()=>t(p),Ja,(gt,Z,Y)=>{var X=cr();let Tt;var ht=i(X),Aa=i(ht);{var Da=O=>{f(O,{icon:"material-symbols:graphic-eq",class:"text-[var(--primary)] animate-pulse"})},La=O=>{var St=it(),te=tt(St);{var ee=dt=>{f(dt,{icon:"material-symbols:pause",class:"text-[var(--primary)]"})},Ma=dt=>{var je=ur();je.textContent=Y+1,N(dt,je)};z(te,dt=>{Y===t(y)?dt(ee):dt(Ma,!1)},!0)}N(O,St)};z(Aa,O=>{Y===t(y)&&t(x)?O(Da):O(La,!1)})}r(ht);var Qt=v(ht,2),Be=i(Qt);r(Qt);var Ae=v(Qt,2),Mt=i(Ae);let De;var ja=i(Mt,!0);r(Mt);var Zt=v(Mt,2);let Le;var Ta=i(Zt,!0);r(Zt),r(Ae),r(X),Pt((O,St,te,ee)=>{Tt=q(X,1,"playlist-item flex items-center gap-3 p-3 hover:bg-[var(--btn-plain-bg-hover)] cursor-pointer transition-colors",null,Tt,O),st(X,"aria-label",`播放 ${t(Z).title??""} - ${t(Z).artist??""}`),st(Be,"src",St),st(Be,"alt",t(Z).title),De=q(Mt,1,"font-medium truncate",null,De,te),G(ja,t(Z).title),Le=q(Zt,1,"text-sm text-[var(--content-meta)] truncate",null,Le,ee),G(Ta,t(Z).artist)},[()=>({"bg-[var(--btn-plain-bg)]":Y===t(y),"text-[var(--primary)]":Y===t(y)}),()=>Et(t(Z).cover),()=>({"text-[var(--primary)]":Y===t(y),"text-90":Y!==t(y)}),()=>({"text-[var(--primary)]":Y===t(y)})]),b("click",X,()=>wt(Y)),b("keydown",X,O=>{(O.key==="Enter"||O.key===" ")&&(O.preventDefault(),wt(Y))}),N(gt,X)}),r(ct),r(m),Pt(gt=>G(D,gt),[()=>Za(Qa.playlist)]),b("click",o,re),ir(3,m,()=>nr,()=>({duration:300,axis:"y"})),N(e,m)};z(Ca,e=>{t(g)&&e(Ba)})}r(ft),Va(2),Pt((e,m,_,B,D,o,V,ct,gt,Z,Y,X,Tt,ht)=>{Ft=q(ft,1,"music-player fixed bottom-4 right-4 z-50 transition-all duration-300 ease-in-out",null,Ft,e),ce=q(R,1,"orb-player w-12 h-12 bg-[var(--primary)] rounded-full shadow-lg cursor-pointer transition-all duration-500 ease-in-out flex items-center justify-center hover:scale-110 active:scale-95",null,ce,m),de=q(nt,1,"mini-player card-base bg-[var(--float-panel-bg)] shadow-xl rounded-2xl p-3 transition-all duration-500 ease-in-out",null,de,_),st(Wt,"src",B),fe=q(Wt,1,"w-full h-full object-cover transition-transform duration-300",null,fe,D),G(aa,t($).title),G(ra,t($).artist),he=q(Bt,1,"expanded-player card-base bg-[var(--float-panel-bg)] shadow-xl rounded-2xl p-4 transition-all duration-500 ease-in-out",null,he,o),st(be,"src",V),xe=q(be,1,"w-full h-full object-cover transition-transform duration-300",null,xe,ct),G(na,t($).title),G(oa,t($).artist),G(la,`${gt??""} / ${Z??""}`),st(ot,"aria-valuenow",t(k)>0?t(P)/t(k)*100:0),Te(da,`width: ${t(k)>0?t(P)/t(k)*100:0}%`),we=q(lt,1,"w-10 h-10 rounded-lg",null,we,Y),lt.disabled=t(p).length<=1,pt.disabled=t(p).length<=1,Ee=q(ut,1,"btn-regular w-12 h-12 rounded-full",null,Ee,X),ut.disabled=t(u),mt.disabled=t(p).length<=1,ke=q(Dt,1,"w-10 h-10 rounded-lg",null,ke,Tt),st(rt,"aria-valuenow",t(j)*100),Te(ka,`width: ${t(j)*100}%`),Ce=q(jt,1,"btn-plain w-8 h-8 rounded-lg",null,Ce,ht)},[()=>({expanded:t(A),"hidden-mode":t(d)}),()=>({"opacity-0":!t(d),"scale-0":!t(d),"pointer-events-none":!t(d)}),()=>({"opacity-0":t(A)||t(d),"scale-95":t(A)||t(d),"pointer-events-none":t(A)||t(d)}),()=>Et(t($).cover),()=>({spinning:t(x)&&!t(u),"animate-pulse":t(u)}),()=>({"opacity-0":!t(A),"scale-95":!t(A),"pointer-events-none":!t(A)}),()=>Et(t($).cover),()=>({spinning:t(x)&&!t(u),"animate-pulse":t(u)}),()=>le(t(P)),()=>le(t(k)),()=>({"btn-regular":t(M),"btn-plain":!t(M)}),()=>({"opacity-50":t(u)}),()=>({"btn-regular":t(h)>0,"btn-plain":t(h)===0}),()=>({"text-[var(--primary)]":t(g)})]),b("click",R,_t),b("keydown",R,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),_t())}),b("click",Ct,Pe(_t)),b("click",Yt,Pe(yt)),b("click",nt,yt),b("keydown",nt,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),yt())}),b("click",At,_t),b("click",Xt,yt),b("click",ot,Ke),b("keydown",ot,e=>{if(e.key==="Enter"||e.key===" "){e.preventDefault(),t(Q).getBoundingClientRect();const _=.5*t(k);t(a)&&(K(a,t(a).currentTime=_),l(P,_))}}),b("click",lt,Ne),b("click",pt,Ye),b("click",ut,We),b("click",mt,It),b("click",Dt,qe),b("click",Lt,oe),b("click",rt,Ue),b("keydown",rt,e=>{(e.key==="Enter"||e.key===" ")&&(e.preventDefault(),e.key==="Enter"&&oe())}),b("click",jt,re),N(n,S)};z(Ve,n=>{n(Xe)})}N(c,ue),Ua()}export{Fr as default};
